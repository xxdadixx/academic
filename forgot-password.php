...
if (isset($_POST['change-pass'])) {
    ...
    if (empty($_POST['op'])) {
        ...
        $query = "SELECT * FROM users WHERE id_card_number = :idcard AND password = :password ";
        $password_verify = password_verify($_POST['op'], $_SESSION['password']);
        $params = [
            'idcard' => $_SESSION['id_card_number'],
        ...
        if ($handle->rowCount() === 1) {
            $query = "UPDATE users SET password=:password WHERE id_card_number=:idcard";
    ...
    <div class="container right-panel-active">
        ...
        <div class="container__form container--signup">
            <form action="forgot-password.php" class="form" method="post">
                ...
                <p class="fieldset">
                    <label class="image-replace">Current Password</label>
                    <input class="full-width has-padding has-border" type="password" placeholder="Current Password" name="op">

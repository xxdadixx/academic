        ...
        <div class="container">
            <div class="row">
                <div class="col">
                    ...
                    <p class="mt-4">Across the globe, thousands of games are played, and football is one of the most famous and enthusiastic game. Almost every nation has a football team, and they have a huge fan following. There are many football tournaments held on national as well as international levels.</p>
                    <p>We can judge how famous the game is by seeing the crowd’s enthusiasm and craze watching a match of their favorite team playing. It is believed that the game was invented in England around the mid-19th century, but there exists controversy as the Chinese claim that they had invented the game.</p>
                    <p>There is a set of rules that a player and the team as a whole have to maintain while playing football, and the International Football Association Board formulates these rules. FIFA or Federation Internationale de Football Association organizes a football world cup every four years, and there is one of the biggest and most eagerly awaited football game.</p>
                </div>
                <div class="col mt-4">
            ...
            <div class="row">
                ...
                <div class="col-xs-6 col-md-3">
                    ...
                    <ul class="footer-links">
                        ...
                        <li><a href="mailto:sanshop4@hotmail.com">Contact Us</a></li>
                        <li><a href="#">Contribute</a></li>
                        <li><a href="pdf/USAFB_Privacy_Policy_2020.pdf" target="_blank">Privacy Policy</a></li>
